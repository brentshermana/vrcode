...
# queue is for passing received messages to owner of client
# buffer is for sending messages outwards
class Client(asyncore.dispatcher):

    def __init__(self, parser, outgoing_msg_queue):
    ...
    def handle_read(self):
        ...
        for parsed_msg in self.parser.read_and_erase():
