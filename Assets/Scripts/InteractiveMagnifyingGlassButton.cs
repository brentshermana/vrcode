...
namespace Leap.Unity.Interaction
{
    ...
    ///</summary>
    public class InteractiveMagnifyingGlassButton : InteractionBehaviour
    {
        ...
        protected virtual void Update()
        {
            ...
            ignoreGrasping = _initialIgnoreGrasping;
            ignoreContact = !controlEnabled;
            ...
            if (_physicsOccurred)
            {
                ...
                if (isDepressed && _lastDepressor != null)
                {
                ...
                if (localPhysicsPosition.z > initialLocalPosition.z - minMaxHeight.x)
                {
                    ...
                    if ((_lastDepressor != null) || isGrasped)
                    {
                        isDepressed = true;
                    }
                    else
