...
public class TheLabRenderer_Settings : EditorWindow
{
	...
	static void Update()
	{
		...
		var devices = UnityEditorInternal.VR.VREditor.GetVREnabledDevicesOnTargetGroup(BuildTargetGroup.Standalone);//GetVREnabledDevices(BuildTargetGroup.Standalone);
		var hasOpenVR = false;
		...
		if (!hasOpenVR)
		{
			...
			UnityEditorInternal.VR.VREditor.SetVREnabledDevicesOnTargetGroup(BuildTargetGroup.Standalone, newDevices);// SetVREnabledDevices(BuildTargetGroup.Standalone, newDevices);
		}
